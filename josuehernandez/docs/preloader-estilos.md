...
- **Tech:** varios textos rotando + `gsap.to` con rotaciones/opacidades escalonadas. *(Existe en motionprompts: "Maxmilkin Orbit Text Preloader".)*
...
Dime cuál eliges (1-15) y lo implemento con GSAP reutilizando la estructura del `Preloader.tsx` actual (flag de sesión + StrictMode-safe + reduced motion).
